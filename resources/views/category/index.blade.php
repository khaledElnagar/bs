                            ...
                            <div id="jm-current-content" class="clearfix">
                                ...
                                @foreach($categories as $category)
                                    ...
                                    <div class="page-title category-title">
                                        <h1>{{$category->name}}</h1>
                                        <a href="{{url('')}}/category/{{$category->id}}" style="float: right;">
                                            See more
                                        </a>
                                    </div>
                                    ...
                                    <div class="category-products">
                                        ...
                                        <ul class="products-grid products-grid-special">
                                            ...
                                            @foreach($category->books->shuffle()->slice(0,5)->take(5) as $book)
                                                @if($counter % 5 == 1)
                                                                ...
                                                                <a href="{{url('')}}/book/{{$book->id}}"
                                                                   ...
                                                                   title="{{$book->name}}">
                                                                    <img id="product-collection-image-2" class="lazy"
                                                                         data-original="{{asset('storage/app/public/images/thumbnail')}}/146x219 @if($book->image!='')/{{$book->image}}@else /noimage.gif @endif"
                                                                         width="150" height="225"
                                                                         alt="{{$book->name}}"/>
                                                                </a>
							<span class="actions">
																<button class="form-button btn-cart"
                                                                        onclick="setLocation('{{url('')}}/book/{{$book->id}}')">
