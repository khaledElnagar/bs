                ...
                <div class="box-content">
                    <form action="{{url('')}}/admin/book/{{$book->id}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>
                                Today Highlight
                                <input type="checkbox" class="form-control" @if($book->highlight==1) checked @endif id="highlight" name="highlight" value="1">
                            </label>
                        </div>
                        ...
                        <div class="form-group">
                            <label>
                                Special Book
                                <input type="checkbox" class="form-control" @if($book->featured_book==1) checked @endif id="featured_book" name="featured_book" value="1">
                            </label>
                        </div>
                        ...
                        <ul class="thumbnails gallery">
                            <li id="image-1" class="thumbnail">
                                <a style="background:url({{asset('storage/app/public/images/normal')}}/{{$book->image}})"
                                   title="{{$book->name}}"
                                   href="{{asset('storage/app/public/images/normal')}}\{{$book->image}}"
                                   class="cboxElement"><img class="grayscale"
                                                            src="{{asset('storage/app/public/images/normal')}}/{{$book->image}}"
                                                            alt="{{$book->name}}" style="display: block;"></a>
                            </li>
                        </ul>
