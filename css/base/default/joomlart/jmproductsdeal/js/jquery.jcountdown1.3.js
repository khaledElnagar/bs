	...
	$.fn.countdown = function( method /*,options*/ ) {  
		...
		var defaults = {
			...
			timerFunc = function() {
				...
				todaysDate = ( settings.offset === null ) ? new Date(settings.cdate) : getTimezoneDate( settings.offset );
				
				countdownDate = new Date( settings.date );
				
				timeLeft = ( settings.direction === 'down' ) ? (countdownDate.getTime() - (todaysDate.getTime()+ repeat*settings.updateTime)) :
